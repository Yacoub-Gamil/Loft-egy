...
function CardItem({ title, image, info, price }) {
  return (
    <div className=" z-40 shadow-[0px_0px_10px_5px_#d5d5d7] p-4 rounded-md flex gap-2 bg-white text-white">
      <div className=" mx-[-4rem] hover:scale-110 duration-300 cursor-pointer w-full rounded-md overflow-hidden">
        <img className="w-[18rem] h-[15.5rem]" src={image} alt="" />
      </div>
