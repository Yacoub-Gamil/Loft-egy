    ...
    <div className=" flex flex-col items-center mt-[4rem]">
      ...
      <div className=" w-full mb-[9rem] p-6 mt-[1rem]">
        <div className=" grid grid-cols-8 justify-center place-items-center ">
          <img className=" w-full h-[17rem]" src="thonet/thonet-1.png" alt="" />
          <img className=" w-full h-[12rem]" src="thonet/thonet-2.png" alt="" />
          <img className=" w-full h-[15rem]" src="thonet/thonet-3.png" alt="" />
          <img
          ...
          <img
            ...
            alt=""
          />
          <img className=" w-full h-[15rem]" src="thonet/thonet-8.png" alt="" />
          <img
            className=" w-[7rem]  h-[15rem]"
