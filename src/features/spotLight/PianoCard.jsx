    ...
    <div id="pianoCard">
      <div className=" p-6 relative ">
        <div className=" w-[60rem]">
          ...
          <p className=" mx-[2rem] text-[1.4rem] mt-[2rem] font-serif">
          ...
          <div className=" grid grid-cols-2 mt-[1rem] place-items-center">
            ...
            <div className=" flex flex-col gap-8  w-full text-[1.2rem] font-serif mx-[2rem]">
              <p className="">
              ...
              <a
                className=" border w-[20rem] text-[1rem] text-center rounded-full tracking-wider uppercase px-2 py-3 hover:bg-black hover:text-white duration-300"
                target="blank"
