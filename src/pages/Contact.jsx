...
function Contact() {
  ...
  return (
    <div id="contact" className="w-full flex items-center flex-col">
      <div>
      ...
      <div className="w-full bg-cover h-[35rem] bg-[url('loft/bg-4.jpg')] bg-no-repeat flex flex-col  justify-center items-center">
        <div className=" w-[50%] p-4 bg-opacity-80 bg-slate-50 flex  flex-col gap-8 items-center shadow-[0px_0px_20px_5px_#e2e8f0]">
          <h1 className=" text-[2rem] font-semibold">Questions or Comments?</h1>
          <p className=" text-[1.4rem] text-center font-semibold italic">
          ...
          <button className=" border font-bold text-[#52525b] tracking-[0.2rem] hover:text-white duration-300 hover:bg-[#dc2626] border-[#52525b] hover:border-[#dc2626] py-2 px-4 uppercase text-[1.4rem]">
            get in toush!
          </button>
        </div>
      </div>
      <div className=" mt-[4rem]">
        <h1 className=" font-serif tracking-wide text-[2.2rem] italic text-[#52525b] font-semibold border-t">
        ...
        <div className=" grid grid-cols-2 mt-[2rem] gap-[1.2rem] place-items-center">
          <div className="  h-full flex flex-col gap-[2rem] uppercase justify-center">
            <div>
              <h1 className="  text-[1.8rem]  italic font-serif font-semibold mb-[.4rem]">
                Still better, visit us in person!
              </h1>
              <p className="text-[#52525b] mx-[1rem] text-[1.2rem]">
            ...
            <div>
              ...
              <p className=" text-[#52525b] mx-[1rem] w-[30rem] text-[1.2rem]">
